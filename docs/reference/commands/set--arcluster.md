...
**Make the callsign an AR-Cluster node**
...
Source: `cmd/set/arcluster.pl` · SHA-256 `7a07bf7293797d6acb664f1ab85670a24cde72c8661334ed6b980aed71d72998`
...
L43: push @out, $self->msg($create ? 'noderc' : 'noder', $call);
...
[View the current command source on GitHub](https://github.com/EA3CV/dxspider/blob/b53589e2425e5ba27b6623611571470f278140c1/cmd/set/arcluster.pl){ .md-button }
