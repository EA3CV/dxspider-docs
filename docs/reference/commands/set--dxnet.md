...
**Make the callsign an DXNet node**
...
Source: `cmd/set/dxnet.pl` · SHA-256 `930a368e7ace3bba9ba59dfa101340284e8f492b93111ac3977b6320e0e46ec8`
...
L43: push @out, $self->msg($create ? 'nodexc' : 'nodex', $call);
...
[View the current command source on GitHub](https://github.com/EA3CV/dxspider/blob/b53589e2425e5ba27b6623611571470f278140c1/cmd/set/dxnet.pl){ .md-button }
