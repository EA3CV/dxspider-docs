...
Source: `cmd/set/spider.pl` · SHA-256 `08e8112a3322afe7aa1e8806310e8a10f04116381df1b5315f8546299076000e`
...
L43: push @out, $self->msg($create ? 'nodesc' : 'nodes', $call);
...
[View the current command source on GitHub](https://github.com/EA3CV/dxspider/blob/b53589e2425e5ba27b6623611571470f278140c1/cmd/set/spider.pl){ .md-button }
